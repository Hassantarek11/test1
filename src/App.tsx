    ...
    const handleUrlRouting = () => {
      ...
      if (kashierCallback && merchantOrderId && paymentStatus) {
        ...
        if (paymentStatus.toUpperCase() === 'SUCCESS') {
          ...
          alert('عذراً، تم إلغاء أو فشلت عملية الدفع عبر إيزي باي. يرجى المحاولة مجدداً.');
          setView('search');
          setSelectedStudent(null);
        }
        return;
          ...
          <div className="max-w-7xl mx-auto px-4 py-3.5 flex flex-col sm:flex-row justify-between items-center gap-3">
            <div className="flex items-center gap-3 cursor-pointer select-none" onClick={handleLogoClick}>
              ...
              <div className="text-right">
                <span className="block font-black text-xs text-emerald-300 tracking-wide uppercase">الأزهر الشريف - معهد عبد الفتاح عزام بنين</span>
                <span className="block font-bold text-sm tracking-tight">نظام الاستعلام عن الشهادات والنتائج المعتمدة</span>
              </div>
            </div>
