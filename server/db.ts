...
const INITIAL_STUDENTS: Student[] = [
  {
    ...
    grade: 'ممتاز',
    percentage: 95.5,
    school_name: 'معهد عبد الفتاح عزام بنين',
    school_year: '2025 - 2026',
    price: 150,
    is_paid: false,
    subject_grades: {
      'القرآن الكريم|100': 96,
      'الفقه الشافعي|40': 38,
      'الحديث وعلومه|40': 37,
      'التفسير|40': 39,
      'التوحيد|40': 36,
      'النحو والصرف|40': 38,
      'اللغة الإنجليزية|60': 54
    },
  ...
  },
  {
    ...
    full_name: 'حسن طارق حسن محمد عبد الفتاح',
    grade: 'جيد جداً',
    percentage: 88.2,
    school_name: 'معهد عبد الفتاح عزام بنين',
    school_year: '2025 - 2026',
    ...
    subject_grades: {
      'القرآن الكريم|100': 88,
      'الفقه الحنفي|40': 34,
      'الحديث وعلومه|40': 35,
      'التفسير|40': 36,
      'التوحيد|40': 33,
      'النحو والصرف|40': 35,
      'اللغة الإنجليزية|60': 48
    },
    certificate_hash: generateHash('1002', 'حسن طارق حسن محمد عبد الفتاح')
  },
  {
    id: 'student-3',
    seat_number: '1003',
    ...
    subject_grades: {
      'القرآن الكريم|100': 68,
      'الفقه الشافعي|40': 25,
      'الحديث وعلومه|40': 26,
      'التفسير|40': 24,
      'التوحيد|40': 23,
      'النحو والصرف|40': 25,
      'اللغة الإنجليزية|60': 36
    },
